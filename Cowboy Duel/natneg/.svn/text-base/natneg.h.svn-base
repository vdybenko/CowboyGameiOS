...
//		Make sure you copy the remoteaddr structure before the callback returns.<p>
...
//		This should only be performed when connecting to a server.  It should not be used
//		during server browsing as it will create unnecessary load on the GameSpy NAT service.
// See Also
