...
// Remarks
//		Make sure you don't accidentally use these to compare against a GHTTPRequest value.
//		To check if a GHTTPRequest has returned an error use the IS_GHTTP_ERROR macro.
typedef enum
{
...
//		necessary to save the buffer that was passed to the callback for later use.
//		Otherwise (e.g. when the buffer is no longer need or has been copied with the 
//		callback), it returns GHTTPTrue.
//		<p>
//		The GHTTP SDK will free the buffer if the callback returns GHTTPTrue.  Overuse of
//		GHTTPFalse can lead to memeory leaks.
// See Also
...
//		processing. Non-blocking mode should be use as much as possible.
//		<p />
...
// Remarks
//		By default, post objects created with ghttpNewPost will be
//		 automatically freed after being used in a request.
//		However ghttpPostSetAutoFree can be used to turn off the post
//		 object's auto-free property. 
//		This can be useful if a single post object will be used in multiple
//		 requests. 
//		You should then use this function to manually free the post object
//		 after the 
//		last request it has been used in completes.
// See Also
//		ghttpNewPost, ghttpPostSetAutoFree
...
// ghttpSetRootCAList
// Summary
//      This function is used for setting the root certificate list
//      when making https calls, if the SSL Engine used supports the setting of
//      expected server root certificate from validation purposes. 
// Parameters
//      url       : [in] 
...
//      theRootCA. This pointer must be valid until the application
//      has completed. 
