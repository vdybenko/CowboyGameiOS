...
- (void)apiDialogFeedUser;
{
    ...
    Facebook *facebook2 = [[Facebook alloc]
                     initWithAppId:FBSession.activeSession.appID
                     andDelegate:nil];
    
    // Store the Facebook session information
    facebook2.accessToken = FBSession.activeSession.accessToken;
    facebook2.expirationDate = FBSession.activeSession.expirationDate;
    [facebook2 dialog:@"feed" andParams:params2 andDelegate:self];
