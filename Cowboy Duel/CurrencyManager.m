...
-(void)_reallyUpdate{
    @autoreleasepool {
        ...
        NSString* urlString = [NSString stringWithFormat:@"%@?open_udid=%@", kAdColonyVirtualCurrencyTestBalanceURL, [AdColony getOpenUDID]];
	NSURL* url = [NSURL URLWithString:urlString];
	NSString *response = [[NSString alloc] initWithData:[NSData dataWithContentsOfURL:url] encoding:NSUTF8StringEncoding];
